function [result, setopt, fftc] = run_projection(xx0,yy0,tgrid,result_la,niter,varargin)
...
% result = infere_latent_var(yy,nf,setopt,xx,fftc,result_la.xxsamp,p.Results.segproject);  
